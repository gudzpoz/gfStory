...
_attached_stories: list[tuple[str, str, str]] = [
    ...
    # 茧中蝶影
    ('-42-3-1first.txt', '-42-3-2.txt', '记忆碎片 1'),
    ('-42-3-2.txt', '-42-3-3.txt', '记忆碎片 2'),
    ('-42-3-3.txt', '-42-3-4.txt', '记忆碎片 3'),
    ('-42-3-4.txt', '-42-3-5.txt', '记忆碎片 4'),
    ('-42-3-5.txt', '-42-3-6.txt', '记忆碎片 5'),
    ('-42-3-6.txt', '-42-3-7.txt', '记忆碎片 6'),
